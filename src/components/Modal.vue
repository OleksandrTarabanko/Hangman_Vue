...
<template>
    <div v-if="guessed" class="modalBackdrop">
        <div class="modal">
            <div>
                <svg width="50px" height="50px" viewBox="0 -4 30 30" version="1.1" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <g id="icons" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        <g id="ui-gambling-website-lined-icnos-casinoshunter"
                            transform="translate(-735.000000, -1911.000000)" fill="url(#linearGradient-1)"
                            fill-rule="nonzero">
    ...
    <div v-if="!hearts" class="modalBackdrop">
        <div class="modal">
            <div>
